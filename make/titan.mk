...
release-titan: release-common release-$(BOXTYPE) $(D)/titan
	...
	install -d $(RELEASE_DIR)/usr/share/titan/{skin,po,web,plugins}
	install -d $(RELEASE_DIR)/usr/share/titan/po/{de,el,en,es,fr,it,lt,nl,pl,ru,vi}
	install -d $(RELEASE_DIR)/usr/share/titan/po/de/LC_MESSAGES
	install -d $(RELEASE_DIR)/usr/share/titan/po/el/LC_MESSAGES
	install -d $(RELEASE_DIR)/usr/share/titan/po/en/LC_MESSAGES
	install -d $(RELEASE_DIR)/usr/share/titan/po/es/LC_MESSAGES
	install -d $(RELEASE_DIR)/usr/share/titan/po/fr/LC_MESSAGES
	install -d $(RELEASE_DIR)/usr/share/titan/po/it/LC_MESSAGES
	install -d $(RELEASE_DIR)/usr/share/titan/po/lt/LC_MESSAGES
	install -d $(RELEASE_DIR)/usr/share/titan/po/nl/LC_MESSAGES
	install -d $(RELEASE_DIR)/usr/share/titan/po/pl/LC_MESSAGES
	install -d $(RELEASE_DIR)/usr/share/titan/po/ru/LC_MESSAGES
	install -d $(RELEASE_DIR)/usr/share/titan/po/vi/LC_MESSAGES
	install -d $(RELEASE_DIR)/usr/share/fonts
	...
	cp -af $(SKEL_ROOT)/usr/share/fonts $(RELEASE_DIR)/usr/share
	cp -aR $(SOURCE_DIR)/titan/skins/default $(RELEASE_DIR)/usr/share/titan/skin
	cp -aR $(SOURCE_DIR)/titan/web $(RELEASE_DIR)/usr/share/titan	
#
# po
#
